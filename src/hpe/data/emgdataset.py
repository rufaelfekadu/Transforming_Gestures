...
class EmgDataset(Dataset):
    def __init__(self, cfg, data_paths, training_mode='pretrain', transforms=(None, None, None)):
        ...
        npz_files = read_dirs(data_paths,['.npz'])[0]
        merged_data = []
        print(npz_files)
...
def build_dataloaders(cfg, pretrain=True):
    ...
    dataloaders['val'] = torch.utils.data.DataLoader(val_set, batch_size=cfg.SOLVER.BATCH_SIZE, shuffle=True, num_workers=num_workers, persistent_workers=True, drop_last=False)
